  ...
  async init() {
    this.server.tool(
      ...
      async () => {
        return ok({
          descricao:
            "O Painel Sintético Concorde é um painel de 787 personas sintéticas do consumidor bancário brasileiro, calibrado com dados públicos (IBGE, Bacen, ABEP), com erro médio de 6,3 p.p. contra pesquisa real em perguntas de atitude — site: https://painel.concorde-painel.workers.dev. Cada persona tem ~27 atributos, uma seção de Grounding (fatos estatísticos que se aplicam ao seu segmento, com fonte) e uma História em prosa. Bancos de referência: 105 fatos estatísticos com filtro determinístico, 17 vozes verbatim reais por tema, 24 fichas de instituições financeiras e tabelas de distribuição.",
          como_usar:
